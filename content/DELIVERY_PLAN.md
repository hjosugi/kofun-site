...
- `51` curated issues are scheduled and
...
| [#551](https://github.com/hjosugi/kofun/issues/551) | `writer-c` | ready | P1 | M | 2026-08-20 | 2026-08-25 | 2026-08-26 | medium | Law declarations: make Monad a library law, not a compiler keyword |
...
| [#626](https://github.com/hjosugi/kofun/issues/626) | `writer-c` | ready | P1 | M | 2026-08-26 | 2026-08-31 | 2026-09-02 | medium | Composable sequencing syntax: Result-first propagation and law-generic bind |
...
| [#627](https://github.com/hjosugi/kofun/issues/627) | `writer-c` | ready | P1 | M | 2026-09-01 | 2026-09-04 | 2026-09-07 | medium | Reactive programming: small Stream/Signal protocol with explicit demand and ownership |
...
| [#625](https://github.com/hjosugi/kofun/issues/625) | `writer-c` | needs-decision | P1 | M | 2026-09-07 | 2026-09-15 | 2026-09-16 | low | Function-call ergonomics: labelled arguments and one trailing-lambda rule |
...
| [#112](https://github.com/hjosugi/kofun/issues/112) | `writer-c` | needs-detail | P1 | S | 2026-09-16 | 2026-09-21 | 2026-09-22 | low | Shadowing: allow ancestor bindings and reject same-scope duplicates |
...
| [#281](https://github.com/hjosugi/kofun/issues/281) | `writer-c` | needs-detail | P1 | M | 2026-09-22 | 2026-09-29 | 2026-09-30 | low | Position paper: what replacing C and Rust actually requires |
...
| [#554](https://github.com/hjosugi/kofun/issues/554) | `writer-c` | needs-detail | P1 | S | 2026-09-30 | 2026-10-05 | 2026-10-06 | low | Backend strategy: reject MLIR, keep the self-hosted backend — with measured costs |
...
| [#556](https://github.com/hjosugi/kofun/issues/556) | `writer-c` | needs-detail | P1 | S | 2026-10-06 | 2026-10-09 | 2026-10-14 | low | Effect systems: ship pure/impure first; multi-shot continuations are unsound with take |
| [#557](https://github.com/hjosugi/kofun/issues/557) | `writer-a` | needs-detail | P1 | S | 2026-10-07 | 2026-10-12 | 2026-10-15 | low | Reading list for the type checker: what to copy, what to skip |
...
| [#570](https://github.com/hjosugi/kofun/issues/570) | `writer-c` | needs-detail | P1 | S | 2026-10-12 | 2026-10-15 | 2026-10-19 | low | Austral: propagate ownership kind structurally through generics and ADTs |
| [#571](https://github.com/hjosugi/kofun/issues/571) | `writer-a` | needs-detail | P1 | S | 2026-10-13 | 2026-10-16 | 2026-10-20 | low | Austral/Nim: support zero-copy borrowed results without user-written lifetimes |
...
| [#574](https://github.com/hjosugi/kofun/issues/574) | `writer-c` | needs-detail | P1 | S | 2026-10-16 | 2026-10-21 | 2026-10-23 | low | V: generate audited C bindings from Clang AST before attempting source translation |
...
| [#639](https://github.com/hjosugi/kofun/issues/639) | `writer-c` | in-progress | P2 | M | 2026-10-22 | 2026-10-27 | 2026-10-29 | medium | Date and time contract: instants, civil calendars, time zones, parsing, and deterministic clocks |
| [#640](https://github.com/hjosugi/kofun/issues/640) | `writer-b` | in-progress | P2 | M | 2026-10-28 | 2026-11-02 | 2026-11-04 | medium | Benchmark harness contract: warmup, sampling, allocation metrics, and reproducible reports |
| [#70](https://github.com/hjosugi/kofun/issues/70) | `writer-c` | ready | P2 | M | 2026-10-28 | 2026-11-02 | 2026-11-05 | medium | Optional frontend: parse null and T? into typed IR |
| [#757](https://github.com/hjosugi/kofun/issues/757) | `writer-a` | ready | P2 | M | 2026-11-02 | 2026-11-05 | 2026-11-06 | medium | Build entry point: replace the Makefile with a Taskfile, keeping every gate byte-identical |
| [#735](https://github.com/hjosugi/kofun/issues/735) | `writer-b` | needs-decision | P2 | M | 2026-11-03 | 2026-11-11 | 2026-11-12 | low | One-shot effect handlers: affine resumptions with a runtime double-resume backstop |
| [#736](https://github.com/hjosugi/kofun/issues/736) | `writer-c` | needs-decision | P2 | M | 2026-11-03 | 2026-11-11 | 2026-11-13 | low | Deterministic structured concurrency: versioned schedule traces, strict replay, and bounded exploration |
| [#740](https://github.com/hjosugi/kofun/issues/740) | `writer-a` | needs-decision | P2 | M | 2026-11-06 | 2026-11-16 | 2026-11-17 | low | Term-level semantic identity: evaluate rename-stable hashes, caches, and structural diffs |
| [#742](https://github.com/hjosugi/kofun/issues/742) | `writer-b` | needs-decision | P2 | M | 2026-11-12 | 2026-11-20 | 2026-11-23 | low | Validation accumulation: collect independent errors without running dependent checks |
| [#558](https://github.com/hjosugi/kofun/issues/558) | `writer-c` | needs-detail | P2 | S | 2026-11-12 | 2026-11-17 | 2026-11-18 | low | What verification actually costs — and why proof-to-code ratios don't measure dependent types |
| [#572](https://github.com/hjosugi/kofun/issues/572) | `writer-a` | needs-detail | P2 | S | 2026-11-17 | 2026-11-20 | 2026-11-24 | low | Nim: infer last-use moves and add a compile-time move assertion |
| [#576](https://github.com/hjosugi/kofun/issues/576) | `writer-c` | needs-detail | P2 | S | 2026-11-18 | 2026-11-23 | 2026-11-25 | low | Koka: reuse matched ADT constructors in place when storage is unique |
...
| [#645](https://github.com/hjosugi/kofun/issues/645) | `writer-b` | needs-detail | P2 | M | 2026-11-23 | 2026-11-30 | 2026-12-02 | low | Date/time core: Gregorian values, checked arithmetic, and strict RFC 3339 |
| [#646](https://github.com/hjosugi/kofun/issues/646) | `writer-c` | needs-detail | P2 | M | 2026-11-24 | 2026-12-01 | 2026-12-03 | low | Benchmark report v1: canonical raw-sample codec and deterministic summaries |
...
| [#648](https://github.com/hjosugi/kofun/issues/648) | `writer-b` | needs-detail | P2 | M | 2026-12-01 | 2026-12-08 | 2026-12-10 | low | Time-zone data v1: versioned tiny tzdb reader with gap and fold resolution |
...
| 2026-08-17 | #271, #551, #622, #636, #637, #724 | #622, #636, #637 | 14/15 |
| 2026-08-24 | #271, #272, #551, #626, #724 | #271, #551, #724 | 12/15 |
| 2026-08-31 | #272, #274, #626, #627, #725 | #272, #626 | 14/15 |
| 2026-09-07 | #27, #274, #625, #627, #725 | #274, #627, #725 | 12/15 |
| 2026-09-14 | #27, #112, #276, #625, #726 | #27, #625 | 15/15 |
| 2026-09-21 | #112, #276, #281, #726 | #112, #726 | 13/15 |
| 2026-09-28 | #276, #281, #533, #554, #555 | #276, #281 | 15/15 |
| 2026-10-05 | #533, #554, #555, #556, #557 | #554, #555 | 15/15 |
| 2026-10-12 | #533, #556, #557, #569, #570, #571, #573, #574 | #533, #556, #557, #569 | 15/15 |
